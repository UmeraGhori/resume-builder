...
const Template3 = ({ data }) => {
    ...
    return (
        <Paper elevation={3} sx={{ padding: 4, maxWidth: 800, margin: '0 auto' }}>
            <Box display="flex" alignItems="center" mb={2} sx={{ backgroundColor: '#FFAE42', padding: 2, borderRadius: 2 }}>
                <Avatar
            ...
            <Box mb={4} sx={{ backgroundColor: '#f5f5f5', padding: 2, borderRadius: 2 }}>
                <Typography variant="h6" fontWeight="bold" color="#FFAE42" gutterBottom>
            ...
            <Box mb={4}>
                ...
                <Divider sx={{ mb: 2, bgcolor: '#FFAE42' }} />
